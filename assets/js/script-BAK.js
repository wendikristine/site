...
jQuery(document).ready(function() {
  ...
  if (jQuery('[data-toggle=isotope-grid]').length > 0) {
    ...
    jQuery().themeLoadPlugin([
      ...
      "https://unpkg.com/isotope-layout@3/dist/isotope.pkgd.min.js"], [], initIsotope);
  }
  ...
  // ----------------------------------------------------------------
  var initOwlCarousel = function(context) {
    if (typeof context === "undefined" || context === null) {
      context = $(document);
    }
    
    jQuery('[data-toggle="owl-carousel"]', context).each(function() {
    ...
    $('[data-owl-carousel-thumbs]', context).each(function() {
  ...
  if (jQuery('[data-toggle="owl-carousel"]').length > 0) {
    jQuery().themeLoadPlugin(
      ...
      ["https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.2.0/assets/owl.carousel.min.css", "https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.5.2/animate.min.css"],
      initOwlCarousel
    );
  }
    ...
    var initMagnificPopup = function() {
	  ...
	  $.magnificPopup.instance.prev = function() {
	    ...
	    setTimeout(function() { $.magnificPopup.proto.prev.call(self); }, 120);
          ...
          setTimeout(function() { $this.wrap.addClass(mfpImgLoadedClass); }, 10);
        });
      });
    };
    jQuery().themeLoadPlugin(
      ["magnific-popup/dist/jquery.magnific-popup.min.js"],
      ["_overrides/plugin-magnific-popup.css", "magnific-popup/dist/magnific-popup.css"], initMagnificPopup);
  }
  ...
  // @see: http://hilios.github.io/jQuery.countdown/
  // ----------------------------------------------------------------
  var cubes = jQuery('[data-toggle="cbp"]');
  if (cubes.length > 0) {
    var initCube = function() {
      var singlePageUpdateContent = function(t, url, element) {
        var $element = $(element),
        ...
        if (content !== 'ajax' && $(content).size() > 0) {
          ...
          console.log(html);
          t.updateSinglePageInline(html.html());
        }
        ...
        var $this = $(this),
          ...
          defaultSettings = {
            ...
            singlePageInlineCallback: function(url, element) {
              singlePageUpdateContent(this, url, element);
            },            
          },
    ...
    jQuery().themeLoadPlugin(
      ["https://cdnjs.cloudflare.com/ajax/libs/jquery.imagesloaded/4.1.1/imagesloaded.pkgd.min.js", "cubeportfolio-jquery-plugin/cubeportfolio/js/jquery.cubeportfolio.js"],
      ["_overrides/plugin-magnific-popup.css", "_overrides/plugin-cube-portfolio.css", "cubeportfolio-jquery-plugin/cubeportfolio/css/cubeportfolio.min.css"],
      initCube
    );
  }  
});
